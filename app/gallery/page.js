...
export const metadata = {
  ...
  return (
    <main className="container mt-10 ">
      ...
      <p className="mb-5 text-grey">We deliver a unique and truly bespoke approach to delivering international developments to market, with over 10 years success around the world.</p>
      </div>
